                ...
                type_question==='multiple_choice'?
                  <div className={style.multiplechoice}>
                    ...
                    <div className={style.coptions}>
                      <ImRadioUnchecked/> <textarea onClick={handleClickNewOption} name="option" placeholder="Añadir Opción" className={style.txtarea}></textarea>
                    </div>
                  </div>:
                  type_question==='checkboxes'?
                    <div className={style.multiplechoice}>
                      ...
                      <div className={style.coptions}>
                        <ImCheckboxUnchecked/> <textarea onClick={handleClickNewOption} name="option" placeholder="Añadir Opción" className={style.txtarea}></textarea>
                      </div>
                    </div>:
                    type_question==='dropdown'?
                      <div className={style.multiplechoice}>
                        ...
                        <div className={style.coptions}>
                           <textarea onClick={handleClickNewOption} name="option" placeholder="Añadir Opción" className={style.txtarea}></textarea>
                        </div>
                      </div>:
                      type_question==='date'?
                        <div className={style.short}>
